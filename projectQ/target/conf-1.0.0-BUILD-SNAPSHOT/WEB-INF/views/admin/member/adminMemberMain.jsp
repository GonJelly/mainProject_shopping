...
function search_member(search_period){	
    ...
    formObj.method="get";
    formObj.action="/conf/admin/member/adminMemberMain.do";
    formObj.submit();
}
...
function fn_member_detail(order_id){
    ...
    document.body.appendChild(formObj); 
    formObj.method="post";
    formObj.action="/conf/admin/member/memberDetail.do";
    formObj.submit();
...
<table class="list_view">
		<tbody align=center >
			<tr align=center bgcolor="#653514">
   ...
   <DIV id="page_wrap">
		 <c:forEach   var="page" begin="1" end="10" step="1" >
		         <c:if test="${section >1 && page==1 }">
		          <a href="${pageContext.request.contextPath}/admin/member/adminMemberMain.do?section=${section-1}&pageNum=${(page-1)*10 +1 }">&nbsp; &nbsp;</a>
		         </c:if>
		          <a href="${pageContext.request.contextPath}/admin/member/adminMemberMain.do?section=${section}&pageNum=${page}">${(section-1)*10 +page } </a>
		         <c:if test="${page ==10 }">
		          <a href="${pageContext.request.contextPath}/admin/member/adminMemberMain.do?section=${section+1}&pageNum=${page*10+1}">&nbsp; next</a>
		         </c:if> 
	      </c:forEach> 
	</DIV>	
 </c:when>
